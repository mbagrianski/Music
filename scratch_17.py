...
notes1 = [A3, A4, A3,
          B3, B4, X, B3,
          Csh3, Csh3, Csh3, Csh3, B3, Csh3,
          D3, D4, X, D3,
          E3, E3, E3, E3, D3, E3,

          Fsh3, D3, Fsh3, A4, D4, Fsh3, A4, D4,
          Fsh4, A4, D4, Fsh4, A5, Fsh4, D5, Fsh4,
          E4, Fsh4, Gsh4, A5, B5, Csh5, B5, A5, Gsh4, Fsh4, E4,
          D4, B5, A5, Gsh4, Fsh4, E4, D4,
          Csh4, D4, E4, Fsh4, Gsh4, A5, Gsh4, Fsh4, E4, D4, Csh4,
          ]
len_1 = [8, 7.5, .5,
         2, 2, 3.5, .5,
         2, 1.5, .5, 3, .5, .5,
...
notes5 = [A2, Gsh1, A2, B2, Csh2, D2, E2, D2,
          Csh2, B2, A2, B2, Csh2, D2, E2, Csh2,
          D2, Csh2, B2, Csh2, D2, E2, Fsh2, D2,
          E2, D2, Csh2, D2, E2, Fsh2, G2, E2,
          Fsh2, E2, D2, E2, Fsh2, G2, A3, Fsh2,
          G2, Fsh2, E2, D2, Csh2, A2, B2, Csh2,
...
while not quit:
    ...
    if count >= 10 and speed > 0.2:
        if count % 2 == 0 and count < 140:
            speed -= 0.0005
        else:
            speed = original_speed
